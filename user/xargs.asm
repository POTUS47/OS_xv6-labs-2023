...
void xargs_exec(char *program, char **paraments)
{
  ...
  18:	00a05d63          	blez	a0,32 <xargs_exec+0x32>
    {
        wait(0);
  1c:	4501                	li	a0,0
  1e:	00000097          	auipc	ra,0x0
  22:	40e080e7          	jalr	1038(ra) # 42c <wait>
  ...
  3a:	426080e7          	jalr	1062(ra) # 45c <exec>
  3e:	57fd                	li	a5,-1
  40:	fef513e3          	bne	a0,a5,26 <xargs_exec+0x26>
            fprintf(2, "xargs: Error exec %s\n", program);
  44:	8626                	mv	a2,s1
  46:	00001597          	auipc	a1,0x1
  4a:	8fa58593          	addi	a1,a1,-1798 # 940 <malloc+0xe6>
  4e:	4509                	li	a0,2
  50:	00000097          	auipc	ra,0x0
  54:	71e080e7          	jalr	1822(ra) # 76e <fprintf>
}
  58:	b7f9                	j	26 <xargs_exec+0x26>

000000000000005a <xargs>:

void xargs(char **first_arg, int size, char *program_name)
{
  5a:	ab010113          	addi	sp,sp,-1360
  5e:	54113423          	sd	ra,1352(sp)
  62:	54813023          	sd	s0,1344(sp)
  66:	52913c23          	sd	s1,1336(sp)
  6a:	53213823          	sd	s2,1328(sp)
  6e:	53313423          	sd	s3,1320(sp)
  72:	53413023          	sd	s4,1312(sp)
  76:	51513c23          	sd	s5,1304(sp)
  7a:	51613823          	sd	s6,1296(sp)
  7e:	51713423          	sd	s7,1288(sp)
  82:	55010413          	addi	s0,sp,1360
  86:	8aae                	mv	s5,a1
  88:	8b32                	mv	s6,a2
    char buf[1024];
    char *arg[MAXARG];
  ...
  a0:	00158a1b          	addiw	s4,a1,1
  a4:	0a0e                	slli	s4,s4,0x3
  a6:	fb040793          	addi	a5,s0,-80
  aa:	9a3e                	add	s4,s4,a5
    while (read(0, buf + m, 1) == 1)
  ac:	a899                	j	102 <xargs+0xa8>
            arg[0] = program_name;
  ae:	ab643823          	sd	s6,-1360(s0)
            for (int i = 0; i < size; ++i)
  b2:	01505b63          	blez	s5,c8 <xargs+0x6e>
  b6:	ab840713          	addi	a4,s0,-1352
  ba:	87de                	mv	a5,s7
                arg[i + 1] = first_arg[i];
  bc:	6394                	ld	a3,0(a5)
  be:	e314                	sd	a3,0(a4)
            for (int i = 0; i < size; ++i)
  c0:	07a1                	addi	a5,a5,8
  c2:	0721                	addi	a4,a4,8
  c4:	ff279ce3          	bne	a5,s2,bc <xargs+0x62>
            arg[size + 1] = malloc(sizeof(char) * (m + 1));
  c8:	2485                	addiw	s1,s1,1
  ca:	8526                	mv	a0,s1
  cc:	00000097          	auipc	ra,0x0
  d0:	78e080e7          	jalr	1934(ra) # 85a <malloc>
  d4:	b0aa3023          	sd	a0,-1280(s4)
            memcpy(arg[size + 1], buf, m + 1);
  d8:	8626                	mv	a2,s1
  da:	bb040593          	addi	a1,s0,-1104
  de:	00000097          	auipc	ra,0x0
  e2:	326080e7          	jalr	806(ra) # 404 <memcpy>
            // 调用xargs_exec函数执行命令
            xargs_exec(program_name, arg);
  e6:	ab040593          	addi	a1,s0,-1360
  ea:	855a                	mv	a0,s6
  ec:	00000097          	auipc	ra,0x0
  f0:	f14080e7          	jalr	-236(ra) # 0 <xargs_exec>
            free(arg[size + 1]);
  f4:	b00a3503          	ld	a0,-1280(s4)
  f8:	00000097          	auipc	ra,0x0
  fc:	6da080e7          	jalr	1754(ra) # 7d2 <free>
            m = 0;
 100:	4481                	li	s1,0
    while (read(0, buf + m, 1) == 1)
 102:	4605                	li	a2,1
 104:	bb040793          	addi	a5,s0,-1104
 108:	009785b3          	add	a1,a5,s1
 10c:	4501                	li	a0,0
 10e:	00000097          	auipc	ra,0x0
 112:	32e080e7          	jalr	814(ra) # 43c <read>
 116:	4785                	li	a5,1
 118:	00f51b63          	bne	a0,a5,12e <xargs+0xd4>
        if (buf[m] == '\n')
 11c:	fb040793          	addi	a5,s0,-80
 120:	97a6                	add	a5,a5,s1
 122:	c007c783          	lbu	a5,-1024(a5)
 126:	f93784e3          	beq	a5,s3,ae <xargs+0x54>
        }
        else
        {
            m++;
 12a:	2485                	addiw	s1,s1,1
 12c:	bfd9                	j	102 <xargs+0xa8>
        }
    }
}
 12e:	54813083          	ld	ra,1352(sp)
 132:	54013403          	ld	s0,1344(sp)
 136:	53813483          	ld	s1,1336(sp)
 13a:	53013903          	ld	s2,1328(sp)
 13e:	52813983          	ld	s3,1320(sp)
 142:	52013a03          	ld	s4,1312(sp)
 146:	51813a83          	ld	s5,1304(sp)
 14a:	51013b03          	ld	s6,1296(sp)
 14e:	50813b83          	ld	s7,1288(sp)
 152:	55010113          	addi	sp,sp,1360
 156:	8082                	ret
...
int main(int argc, char *argv[])
{
 ...
 15e:	0800                	addi	s0,sp,16
    if(argc<1){
 160:	02a05163          	blez	a0,182 <main+0x2a>
 164:	87ae                	mv	a5,a1
 ...
 166:	6590                	ld	a2,8(a1)
 168:	fff5059b          	addiw	a1,a0,-1
 16c:	00878513          	addi	a0,a5,8
 170:	00000097          	auipc	ra,0x0
 174:	eea080e7          	jalr	-278(ra) # 5a <xargs>
    }
    exit(0);
 178:	4501                	li	a0,0
 17a:	00000097          	auipc	ra,0x0
 17e:	2aa080e7          	jalr	682(ra) # 424 <exit>
        printf("we need more arguments");
 182:	00000517          	auipc	a0,0x0
 186:	7d650513          	addi	a0,a0,2006 # 958 <malloc+0xfe>
 18a:	00000097          	auipc	ra,0x0
 18e:	612080e7          	jalr	1554(ra) # 79c <printf>
 192:	b7dd                	j	178 <main+0x20>
...
_main()
{
 ...
 1a0:	fbc080e7          	jalr	-68(ra) # 158 <main>
  exit(0);
 1a4:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	47050513          	addi	a0,a0,1136 # 978 <digits>
 510:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d8:	3a4b8b93          	addi	s7,s7,932 # 978 <digits>
 ...
 718:	25c90913          	addi	s2,s2,604 # 970 <malloc+0x116>
        while(*s != 0){
