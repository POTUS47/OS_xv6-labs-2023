...
void childProcess(int p_left[2])
{
  ...
  18:	414080e7          	jalr	1044(ra) # 428 <read>
  1c:	04a05863          	blez	a0,6c <childProcess+0x6c>
    {
        close(p_left[0]); // 关闭读端
        exit(0);
    }
  ...
  30:	75c080e7          	jalr	1884(ra) # 788 <printf>

    int p_right[2];
    pipe(p_right);
  34:	fd040513          	addi	a0,s0,-48
  38:	00000097          	auipc	ra,0x0
  3c:	3e8080e7          	jalr	1000(ra) # 420 <pipe>

    if (fork() == 0)
  40:	00000097          	auipc	ra,0x0
  44:	3c8080e7          	jalr	968(ra) # 408 <fork>
  48:	ed05                	bnez	a0,80 <childProcess+0x80>
    {
        close(p_right[1]); // 子进程关闭写端
  4a:	fd442503          	lw	a0,-44(s0)
  4e:	00000097          	auipc	ra,0x0
  52:	3ea080e7          	jalr	1002(ra) # 438 <close>
        childProcess(p_right);
  56:	fd040513          	addi	a0,s0,-48
  5a:	00000097          	auipc	ra,0x0
  5e:	fa6080e7          	jalr	-90(ra) # 0 <childProcess>
        close(p_left[0]);  // 关闭读端
  ...
  7c:	398080e7          	jalr	920(ra) # 410 <exit>
        close(p_right[0]); // 父进程关闭读端
  80:	fd042503          	lw	a0,-48(s0)
  84:	00000097          	auipc	ra,0x0
  88:	3b4080e7          	jalr	948(ra) # 438 <close>
        while (read(p_left[0], &num, sizeof(num)) > 0)
  8c:	4611                	li	a2,4
  8e:	fcc40593          	addi	a1,s0,-52
  92:	4088                	lw	a0,0(s1)
  94:	00000097          	auipc	ra,0x0
  98:	394080e7          	jalr	916(ra) # 428 <read>
  9c:	02a05363          	blez	a0,c2 <childProcess+0xc2>
            if (num % prime != 0)
  a0:	fcc42783          	lw	a5,-52(s0)
  a4:	fdc42703          	lw	a4,-36(s0)
  a8:	02e7e7bb          	remw	a5,a5,a4
  ac:	d3e5                	beqz	a5,8c <childProcess+0x8c>
                write(p_right[1], &num, sizeof(num));
  ae:	4611                	li	a2,4
  b0:	fcc40593          	addi	a1,s0,-52
  b4:	fd442503          	lw	a0,-44(s0)
  b8:	00000097          	auipc	ra,0x0
  bc:	378080e7          	jalr	888(ra) # 430 <write>
  c0:	b7f1                	j	8c <childProcess+0x8c>
        close(p_left[0]);  // 关闭读端
  c2:	4088                	lw	a0,0(s1)
  c4:	00000097          	auipc	ra,0x0
  c8:	374080e7          	jalr	884(ra) # 438 <close>
        close(p_right[1]); // 关闭写端
  cc:	fd442503          	lw	a0,-44(s0)
  d0:	00000097          	auipc	ra,0x0
  d4:	368080e7          	jalr	872(ra) # 438 <close>
        wait(0);           // 等待子进程结束
  d8:	4501                	li	a0,0
  da:	00000097          	auipc	ra,0x0
  de:	33e080e7          	jalr	830(ra) # 418 <wait>
        exit(0);
  e2:	4501                	li	a0,0
  e4:	00000097          	auipc	ra,0x0
  e8:	32c080e7          	jalr	812(ra) # 410 <exit>
...
int main(int argc, char *argv[])
{
  ...
  fe:	326080e7          	jalr	806(ra) # 420 <pipe>

    if (fork() == 0)
 102:	00000097          	auipc	ra,0x0
 106:	306080e7          	jalr	774(ra) # 408 <fork>
 10a:	ed11                	bnez	a0,126 <main+0x3a>
    {
        close(p[1]); // 子进程关闭写端
 10c:	fdc42503          	lw	a0,-36(s0)
 110:	00000097          	auipc	ra,0x0
 114:	328080e7          	jalr	808(ra) # 438 <close>
        childProcess(p);
 118:	fd840513          	addi	a0,s0,-40
 11c:	00000097          	auipc	ra,0x0
 120:	ee4080e7          	jalr	-284(ra) # 0 <childProcess>
 124:	a889                	j	176 <main+0x8a>
    }
    else
    {
        close(p[0]); // 父进程关闭读端
 ...
 12e:	30e080e7          	jalr	782(ra) # 438 <close>
        for (int i = 2; i <= 35; i++)
 132:	4789                	li	a5,2
 134:	fcf42a23          	sw	a5,-44(s0)
 138:	02300493          	li	s1,35
        {
            write(p[1], &i, sizeof(i)); // 写入整数
 13c:	4611                	li	a2,4
 13e:	fd440593          	addi	a1,s0,-44
 142:	fdc42503          	lw	a0,-36(s0)
 146:	00000097          	auipc	ra,0x0
 14a:	2ea080e7          	jalr	746(ra) # 430 <write>
        for (int i = 2; i <= 35; i++)
 14e:	fd442783          	lw	a5,-44(s0)
 152:	2785                	addiw	a5,a5,1
 154:	0007871b          	sext.w	a4,a5
 158:	fcf42a23          	sw	a5,-44(s0)
 15c:	fee4d0e3          	bge	s1,a4,13c <main+0x50>
        }
        close(p[1]); // 关闭写端
 160:	fdc42503          	lw	a0,-36(s0)
 164:	00000097          	auipc	ra,0x0
 168:	2d4080e7          	jalr	724(ra) # 438 <close>
        wait(0);     // 等待子进程结束
 16c:	4501                	li	a0,0
 16e:	00000097          	auipc	ra,0x0
 172:	2aa080e7          	jalr	682(ra) # 418 <wait>
    }
...
_main()
{
 ...
 18c:	f64080e7          	jalr	-156(ra) # ec <main>
  exit(0);
 190:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f8:	45450513          	addi	a0,a0,1108 # 948 <digits>
 4fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c4:	388b8b93          	addi	s7,s7,904 # 948 <digits>
 ...
 704:	24090913          	addi	s2,s2,576 # 940 <malloc+0xfa>
        while(*s != 0){
